...
<body>
            ...
            ?>
              <div id="editdiv" style="display: <?php echo $display?>;">
                <form method="post">
                    ...
                    <input type="text" value="<?php echo $newfName?>" name="newfName">
                    <label>Last Name:</label>
                    <input type="text" value="<?php echo $newlName?>" name="newlName">
                    <label>Email:</label>
                    <input type="text" value="<?php echo $newEmail?>" name="newEmail"><br>
                    <label>Mobile:</label>
                    <input type="text" value="<?php echo $newmobile?>" name="newmobile">
    ...
    <div id="adddiv" style="display: <?php echo $display1?>;">
                <form method="post">
                    <label>First Name:</label>
                    <input type="text"  name="newufName" required>
                    <label>Last Name:</label>
                    <input type="text"  name="newulName" required>
                    <label>Email:</label>
                    <input type="text" name="newuEmail" required><br>
                    <label>Mobile:</label>
                    <input type="text" name="newumobile" required>
                    <label>Password:</label>
                    <input type="text" name="newuPassword" required>
                    <label>Admin:</label>
